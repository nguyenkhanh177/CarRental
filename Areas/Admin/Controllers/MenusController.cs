...
namespace CarRental.Areas.Admin.Controllers
{
    ...
    public class MenusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Idmenu,Title,Alias,Position,ParentMenu")] TbMenu tbMenu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idmenu,Title,Alias,Position,ParentMenu")] TbMenu tbMenu)
        {
            if (id != tbMenu.Idmenu)
            {
                return NotFound();
